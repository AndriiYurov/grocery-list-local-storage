...
const GroceryList = () => {
    ...
    const crossedWord = (id) => {
        const crossed = document.getElementById(id)
        ...
        return(
            ...
            <ul>
                {groceryList.map((item) => (
                    ...
                    <li><img src={check} width="30px" alt="cart"/><button id={item.id} className='li' onClick={() => crossedWord(item.id)}>{item.title}</button></li>
